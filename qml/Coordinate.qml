    ...
    Row {
        ...
        AbstractButton {
            ...
            Label {
                ...
                color: coordinateLoader.sourceComponent === colCoordDecComponent ? UbuntuColors.blue : UbuntuColors.slate
            }
        ...
        AbstractButton {
            ...
            Label {
                ...
                anchors.centerIn: parent
                color: coordinateLoader.sourceComponent === colCoordPolarComponent ? UbuntuColors.blue : UbuntuColors.slate
            }
                ...
                onClicked: {
                    ...
                    try {
                        ...
                        if (!isNaN(aux_lat) && aux_lat.toString().indexOf('.') != -1 && !isNaN(aux_lng) && aux_lng.toString().indexOf('.') != -1 && aux_lat >= -90 && aux_lat <= 90 && aux_lng >= -180 && aux_lng <= 180) { // It's a float
                            ...
                            mainPageStack.executeJavaScript("ui.markers_POI_set([{title: '', lat: " + mainPageStack.clickedLat + ", lng: " + mainPageStack.clickedLng + "}])");
